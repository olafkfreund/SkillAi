...
<CardGrid stagger>
  ...
  <Card title="GDPR-ready" icon="approve-check-circle">
    ...
    [DEC-011](/decisions/dec-011-gdpr-erasure).
  </Card>
...
<CardGrid>
  ...
  <Card title="🏛️ Read the decisions" icon="document">
    ...
    [logged with rationale](/decisions/).
  </Card>
</CardGrid>
...
- [What is SkillAI](/overview/what-is-skillai) — the elevator pitch and the problem space
- [Product tour](/overview/product-tour) — annotated screenshots of every major surface
- [System overview](/architecture/system-overview) — boxes-and-arrows, request lifecycle, AI pipeline
- [Endpoint reference](/rest-api/endpoints) — auto-generated from the OpenAPI spec
- [Tool catalogue](/mcp-server/tools) — auto-generated from the MCP registry
- [Roadmap](/roadmap) — what shipped, what's next
