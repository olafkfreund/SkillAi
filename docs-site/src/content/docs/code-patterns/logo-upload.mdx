...
<Aside type="note">
For the broader storage architecture — why the local Docker volume rather than S3, and the planned Garage upgrade path — see [DEC-005](/decisions/dec-005-storage).
</Aside>
