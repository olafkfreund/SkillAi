...
<Aside type="tip">
The full storage + serving pipeline (validation, path symmetry, the storage helper) is documented on the [logo upload page](/code-patterns/logo-upload/). This page covers only the candidate-side rendering surfaces.
</Aside>
