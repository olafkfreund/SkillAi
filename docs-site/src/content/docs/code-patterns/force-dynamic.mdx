---
title: force-dynamic on public routes
description: Why two routes are pinned to force-dynamic, what bug it works around, and the rule for adding new App Router routes.
sidebar:
  order: 3
---
