---
title: In-app help content
description: How the /dashboard/help articles are authored as flat markdown files, validated by Zod at load time, and filtered by user role.
sidebar:
  order: 5
---
