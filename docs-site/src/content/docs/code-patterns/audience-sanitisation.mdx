...
<Aside type="caution">
Day rates and margin are the canonical example of internal-only data — see [DEC-009](/decisions/dec-009-soft-budget-signal) for why budget context is rendered as a margin pill for recruiters while being deliberately invisible to customers and managers.
</Aside>
