...
- [DEC-001 — Build vs buy](/decisions/dec-001-build-vs-buy/) — the on-premise principle invoked here.
- [DEC-006 — Auth.js v5 over Clerk](/decisions/dec-006-authjs-over-clerk/) — same data-sovereignty reasoning, applied to auth.
