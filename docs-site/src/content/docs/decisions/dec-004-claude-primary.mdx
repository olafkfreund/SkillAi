...
- [DEC-009 — Soft AI signal for day-rate budget](/decisions/dec-009-soft-budget-signal/) — the soft budget signal applies to both Claude and Gemini scoring prompts.
