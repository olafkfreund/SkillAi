...
- The data-sovereignty principle established here is invoked directly by [DEC-006 — Auth.js v5 over Clerk](/SkillAi/decisions/dec-006-authjs-over-clerk/) and [DEC-007 — Manual transcript upload](/SkillAi/decisions/dec-007-manual-transcript-upload/).
