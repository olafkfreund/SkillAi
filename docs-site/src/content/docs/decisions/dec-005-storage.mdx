...
- [DEC-001 — Build vs buy](/SkillAi/decisions/dec-001-build-vs-buy/) — the data-sovereignty principle established here is what rules out S3 / GCS as defaults.
- The Garage migration is an open roadmap item — see [Roadmap → Open work](/SkillAi/roadmap/#open-work).
