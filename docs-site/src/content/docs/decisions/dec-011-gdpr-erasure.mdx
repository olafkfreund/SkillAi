...
- [DEC-003 — Row-Level Security](/SkillAi/decisions/dec-003-row-level-security/) — every delete in the cascade runs inside the `withTenant()` transaction this decision establishes.
