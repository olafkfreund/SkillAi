...
- The pgvector advantage here is what makes semantic candidate search practical — see [DEC-003 — Row-Level Security](/SkillAi/decisions/dec-003-row-level-security/) for how RLS interacts with the schema choices.
