...
- [DEC-001 — Build vs buy](/SkillAi/decisions/dec-001-build-vs-buy/) — the data-sovereignty principle this decision applies.
- [DEC-007 — Manual transcript upload](/SkillAi/decisions/dec-007-manual-transcript-upload/) — the same data-sovereignty argument rules out third-party transcript aggregators.
