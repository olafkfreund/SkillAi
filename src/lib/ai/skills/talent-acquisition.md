<!--
  Vendored from https://github.com/borghei/Claude-Skills/blob/b3f2d35/hr-operations/talent-acquisition/SKILL.md
  Upstream commit: b3f2d35b273bfc9621122c45e034c214ddd06f9e
  Synced: 2026-05-20
  Licence: MIT + Commons Clause (see ./README.md for vendoring + resync workflow)
  Author: borghei

  DO NOT EDIT THIS FILE DIRECTLY.
  When upstream changes, re-sync via the workflow documented in ./README.md
  and preserve this header. SkillAi-specific UK/EU work-auth guidance lives
  in the sibling file `eu-uk-supplement.md` and is loaded alongside this skill.
-->
---
